...
from mmdet.apis import init_dist, get_root_logger, set_random_seed, train_detector
from mmdet.models import build_detector
from mmdet.datasets import build_dataset


def parse_args():
    parser = argparse.ArgumentParser(description="Train a query-guided detector")
    parser.add_argument("--config", default="configs/qg_rcnn_r50_fpn.py")
    parser.add_argument("--work_dir", default="work_dirs/qg_rcnn_r50_fpn")
...
def main():
    ...
    if args.autoscale_lr:
        cfg.optimizer["lr"] = cfg.optimizer["lr"] * cfg.gpus / 8.0
    ops.sys_print("Args:\n--", args)
