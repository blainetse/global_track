...
class VOT(SeqDataset):
    ...
    """
    __valid_versions = [
        2013, 2014, 2015, 2016, 2017, 2018, 'LT2018', 2019, 'LT2019', 2020, 2021,
        'RGBD2019', 'RGBT2019'
    ]
    ...
    def __init__(self,
        ...
        super(VOT, self).__init__(name='VOT-{}'.format(self.version),
    ...
    def _construct_seq_dict(self, root_dir, list_file):
        ...
        anno_files = [osp.join(s, 'groundtruth.txt') for s in seq_dirs]
